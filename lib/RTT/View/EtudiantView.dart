...
import '../ViewModel/EtudiantViewModel.dart';
import '../services/Api/ApiEtudiant.dart';
...
class _ListEtud extends State<ListEtud> {
  ...
  _ListEtud() : EVM = EtudiantViewModel(EtudiantApi());
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            SizedBox(
                                                                                ...
                                                                                ,onPressed:(){
                                                                              setState(() {
                                                                                EVM.updateEtudiant(nom.text,prenom.text,mail.text,phone.text,annonces[id]['id']);
                                                                                Navigator.pop(context,null);
                                                                                getEtud();
                                                                              });
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        SizedBox(
                                                                            ...
                                                                            ,onPressed:(){
                                                                          setState(() {
                                                                            EVM.deleteEtudiant(annonces[id]['id']);
                                                                            getEtud();
                                                                            print("aaa");
                                                                            Navigator.pop(context,null);
                                                                          });
