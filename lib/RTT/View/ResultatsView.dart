...
class Resultatsm extends StatefulWidget {
  const Resultatsm({Key? key}) : super(key: key);
  @override
  State<Resultatsm> createState() => _Resultatsm();
}

class _Resultatsm extends State<Resultatsm> {
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                GestureDetector(
                                    onTap:(){
                                      Navigator.of(context).push(MaterialPageRoute(builder:  (context)=>Resultatsm()));
                                    }
