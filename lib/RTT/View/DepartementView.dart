...
import '../ViewModel/DepartementViewModel.dart';
...
class _DepState extends State<Dep> {
  ...
  final DepartementViewModel DVM;
  _DepState() : DVM = DepartementViewModel(ApiDeppartement());
  ...
  late TextEditingController nomm2;

  late String a;
  late TextEditingController nomm;
  late TextEditingController prenomm ;
  bool isSelected=true;
  List ensei=[
    'Choisir dep',
  ];
  Future<void> getEnseignant()async      {
    Map<String, String> headers = {
      'Authorization': 'Bearer 205|S3qPj3E0T4NQ5tJenKS2SVCUOAEYmbfKaIRytv7C',
      'Accept': 'application/json' //ajout du header CORS dans la requête
  ...
  Widget build(BuildContext context) {
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(width: 10,),
                                Text('Departements',style:TextStyle(color:Colors.white,fontWeight: FontWeight.bold)),
                                Expanded(child: Container()),
                                ...
                                children: [
                                          ...
                                          builder:(context){
                                            return AlertDialog(
                                              content:Container(
                                                ...
                                                child:Column(
                                                  children: [
                                                    Text('Ajouter Departement',style:TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Color(0xFF3d5ee1),
                                                    ),)
                                                    ,SizedBox(height: 30,),
                                                    Container(
                                                        width: 230,
                                                        height: 80
                                                        ,child:TextFormField(
                                                      controller: nomm2 = TextEditingController(
                                                          text:"Nom Departement"),
                                                      decoration: InputDecoration(
                                                        labelText: 'Nom Departement' ,
                                                    ...
                                                    SizedBox(
                                                      ...
                                                      child: DropdownButton<String>(
                                                        value:a, // Pour le menu déroulant enseignant
                                                        items: ensei.map(
                                                              (option) {
                                                    ...
                                                    SizedBox(
                                                        ...
                                                        ,onPressed:(){
                                                      setState(() {
                                                        DVM.ajouterDepartement(nomm2.text, a.substring(0,1));
                                                        //com.AjouterMatieres(nom.text);
                                                        getDepa();
                                                        Navigator.pop(context,null);
                                                      });
                                                    }, child:Text('Ajouter Departement',style:TextStyle(fontWeight: FontWeight.bold,color: Colors.white),))),
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Container(
                                          width: 170,
                                          child: Text('Chef de Dept',style:TextStyle(fontWeight: FontWeight.bold),)), Container(
                                          width: 250
                                    ...
                                    child: Container(
                                      ...
                                      child: StreamBuilder<Map<String,dynamic>>(
                                          ...
                                          builder: (context, AsyncSnapshot<Map<String,dynamic>> snapshot) {
                                            ...
                                            print(data);
                                            List<dynamic> dep = snapshot.data!['departements'];
    ...
    "http://192.168.1.13/ISIMM_eCampus/storage/app/public/${data!['enseignants'][id]['image']}"
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Text(
                                                            dep[id]['nom'],
                                                            //${dep[id]['prenom']} ${data['enseignants'][id]['nom']}
                                                            overflow: TextOverflow.ellipsis,
                                                          ),
                                                        ),
                                                        Container(
                                                          width: 220,
                                                          child: Text(
                                                            dep[id]['chef_departement'][0]['nom']+" "+  dep[id]['chef_departement'][0]['prenom'],
                                                            //${dep[id]['prenom']} ${data['enseignants'][id]['nom']}
                                                            overflow: TextOverflow.ellipsis,
                                                          ),
                                                        ),
                                                        ...
                                                        Container(
                                                          width: 180,
                                                          child: Text(
                                                            dep[id]['enseignants_count'].toString(),
                                                            overflow: TextOverflow.ellipsis,
                                                          ),
                                                        ),
                                                                      ...
                                                                      builder:(context){
                                                                        return AlertDialog(
                                                                          content:Container(
                                                                            ...
                                                                            child:Column(
                                                                              children: [
                                                                                Text('Modifier Departement',style:TextStyle(fontWeight: FontWeight.bold,fontSize: 20,                                color: Color(0xFF3d5ee1),
                                                                                ),)
                                                                                ,SizedBox(height: 30,),
                                                                                Row(
                                                                                  children: [
                                                                                ...
                                                                                Row(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    SizedBox(
                                                                                        ...
                                                                                        ,onPressed:(){
                                                                                      setState(() {
                                                                                        DVM.updateDepartement(dep[id]['id'],nomm.text);
                                                                            ...
                                                                            Row(
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                SizedBox(
                                                                                    ...
                                                                                    ,onPressed:(){
                                                                                  setState(() {
                                                                                    DVM.deleteDepartement(dep[id]['id']);
