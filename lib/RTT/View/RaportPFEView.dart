...
import '../ViewModel/RapportPfeViewModel.dart';
import '../services/Api/ApiDepartement.dart';
import '../services/Api/ApiRapportPFE.dart';
class rapportm extends StatefulWidget {
  const rapportm({Key? key}) : super(key: key);

  @override
  State<rapportm> createState() => _rapportmState();
}

class _rapportmState extends State<rapportm> {
  ...
  final RapportViewModel DVM;
  _rapportmState() : DVM = RapportViewModel();
  ...
  void pickFile(String titre, String description,String phonse) async {
    ...
    final url = "http://192.168.1.13/ISIMM_eCampus/public/api/ajouter_rapport"; // Replace with the endpoint URL of your backend
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                GestureDetector(
                                  onTap:(){
                                    Navigator.of(context).push(MaterialPageRoute(builder:  (context)=>rapportm()));
                                  },
                                  child: Container(
                                      height: 25,
                                      width: 25
                                      ,child: Image.asset('lib/adminstration/img/files-and-folder.png',color:Colors.white,)),
                                ),
                                SizedBox(width: 10,),
                                GestureDetector(
                                    onTap:(){
                                    ...
                                    ,child: Text('Rapports PFE',style:TextStyle(color:Colors.white,fontWeight: FontWeight.bold,))),
                                Expanded(child: Container()),
                                            ...
                                            showDialog(context: (context), builder: (context) {
                                              return AlertDialog(
                                                content:Container(
                                                  ...
                                                  child:Column(
                                                    children: [
                                                      Text('Ajouter Rapport PFE',style:TextStyle(fontWeight: FontWeight.bold,fontSize: 20,                                color: Color(0xFF3d5ee1),
                                                      ),)
                                                      ,SizedBox(height: 30,),
                                                      Row(
                                                        children: [
                                                      ...
                                                      Row(
                                                        children: [
                                                          ...
                                                          TextButton(onPressed:(){
                                                            pickFile(nom.text,prenom.text,phone.text) ;
                                        ...
                                        child:Column(
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                Image.asset('lib/adminstration/img/images (1).jpg',height: 40,),
                                                Expanded(child: Container()),
                                                Container(
                                                  width: 60,
                                                  height: 20,
                                                          ...
                                                          return AlertDialog(
                                                            content:Container(
                                                              ...
                                                              child: Column(
                                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                                children: [
                                                                  Text("Voulez-vous vraiment supprimer ce rapport ?",style:TextStyle(fontWeight: FontWeight.w600,color: Color(0xFF3d5ee1),),),
                                                                  SizedBox(height: 15,),
                                                                  Text("Attention ! Tout le contenu de ce rapport seront définitivement perdus.",style:TextStyle(color: Colors.grey),),
                                                                  SizedBox(height: 15,),
                                                                  Row(
                                                                    mainAxisAlignment: MainAxisAlignment.center,
                                                                    children: [
                                                                      ...
                                                                      SizedBox(
                                                                          ...
                                                                          ,onPressed:(){
                                                                        setState(() {
                                                                          DVM.deleteRapport(rapport[id]['id']);
                                                                          getDepa();
                                                                          print("aaa");
                                                                          Navigator.pop(context,null);
                                                                        });
                                                        ...
                                                        builder:(context){
                                                          return AlertDialog(
                                                            content:Container(
                                                              ...
                                                              child:Column(
                                                                children: [
                                                                  Text('Modifier Rapport PFE',style:TextStyle(fontWeight: FontWeight.bold,fontSize: 22,                                color: Color(0xFF3d5ee1),
                                                                  ),)
                                                                  ,SizedBox(height: 30,),
                                                                  Row(
                                                                    children: [
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      SizedBox(
                                                                          ...
                                                                          ,onPressed:(){
                                                                        setState(() {
                                                                          DVM.updateRapport(nom.text, prenom.text,11);
                                                                          // com.UpdateEnseignant(nom.text,prenom.text,mail.text,phone.text,data['enseignants'][id]['id']);
                                                                          Navigator.pop(context,null);
                                                                          getDepa();
                                                                        });
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                SizedBox(width: 5,),
                                                Text(rapport[id]['annee'],style:TextStyle(fontSize: 12),),
                                                Expanded(child: Container()),
                                                TextButton(
                                                  onPressed: () {},
                                                  child: Stack(
