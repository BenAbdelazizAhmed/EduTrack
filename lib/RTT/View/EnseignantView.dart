...
import '../ViewModel/EnseignantViewModel.dart';
...
class _ListEnseState extends State<ListEnse> {
  final EnseignantViewModel ENVM;
  ...
  _ListEnseState() : ENVM = EnseignantViewModel(ApiEnseignant());
                                                                          ...
                                                                          Row(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              SizedBox(
                                                                                  ...
                                                                                  ,onPressed:(){
                                                                                setState(() {
                                                                                  ENVM.updateEnseignant(nom.text,prenom.text,mail.text,phone.text,data[id]['id']);
                                                                                  Navigator.pop(context,null);
                                                                                  getEnseignant();
                                                                                });
                                                                      ...
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          SizedBox(
                                                                              ...
                                                                              ,onPressed:(){
                                                                            setState(() {
                                                                              ENVM.deleteEnseignant(data[id]['id']);
                                                                              getEnseignant();
                                                                              print("aaa");
                                                                              Navigator.pop(context,null);
                                                                            });
