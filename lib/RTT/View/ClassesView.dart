...
import '../ViewModel/ClaasseViewModel.dart';
import '../services/Api/ApiClasse.dart';
class Classev extends StatefulWidget {
  const Classev({Key? key}) : super(key: key);

  @override
  State<Classev> createState() => _ClassevState();
}

class _ClassevState extends State<Classev> {
  final ClasseViewModel CVM;
  ...
  _ClassevState() : CVM = ClasseViewModel(ClasseApi());
                    ...
                    Container(
                      ...
                      child:ListView(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap:(){
                              Navigator.of(context).push(MaterialPageRoute(builder:  (context)=>Classev()));
                            }
                            ,
                            child: Container(
                              padding: EdgeInsets.symmetric(horizontal:10,vertical:3),
                                ...
                                children: [
                                          ...
                                          builder:(context){
                                            return AlertDialog(
                                              content:Container(
                                                ...
                                                child:Column(
                                                  children: [
                                                    Text('Ajouter Classe',style:TextStyle(fontWeight: FontWeight.bold,fontSize: 20,                                color: Color(0xFF3d5ee1),
                                                    ),)
                                                    ,SizedBox(height: 30,),
                                                    Column(
                                                      children: [
                                                    ...
                                                    SizedBox(
                                                        ...
                                                        ,onPressed:(){
                                                      setState(() {
                                                        CVM.ajouterClasse(nom.text,prenom.text );
                                                        getEnseignant();
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Container(
                                          width: 213,
                                          child: Text('Nom.Classe',style:TextStyle(fontWeight: FontWeight.bold),)),
                                      Container(
                                          width: 180,
                                          child: Text('Nombre de classes',style:TextStyle(fontWeight: FontWeight.bold),)),
                                      Container(
                                          width: 250
                                          ,child: Text('Type de Classe',style:TextStyle(fontWeight: FontWeight.bold),)),
                                    ...
                                    child: Container(
                                      ...
                                      child: StreamBuilder<Map<String,dynamic>>(
                                          ...
                                          builder: (context, AsyncSnapshot<Map<String,dynamic>> snapshot) {
                                            ...
                                            List<dynamic> classes = snapshot.data!['classes'];
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        ...
                                                        Container(
                                                          width: 200,
                                                          child: Text(
                                                            classes[id]['etudiants_count'].toString(),
                                                            overflow: TextOverflow.ellipsis,
                                                          ),
                                                        ),
                                                        Container(
                                                            width: 170,
                                                            child:Text(classes[id]['type']['type'].toString())),
                                                        Expanded(
                                                            flex: 1
                                                            ,child: Row(
                                                          children: [
                                                                      ...
                                                                      builder:(context){
                                                                        return AlertDialog(
                                                                          content:Container(
                                                                            ...
                                                                            child:Column(
                                                                              children: [
                                                                                Text('Modifier Classe',style:TextStyle(fontWeight: FontWeight.bold,fontSize: 20,                                color: Color(0xFF3d5ee1),
                                                                                ),)
                                                                                ,SizedBox(height: 30,),
                                                                                Row(
                                                                                  children: [
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    SizedBox(
                                                                                      ...
                                                                                      setState(() {
                                                                                        ...
                                                                                        CVM.updateClasse(nom.text, classes[id]['id'].toString());
                                                                                        Navigator.pop(context,null);
                                                                                        getEnseignant();
                                                                                      });
                                                                            ...
                                                                            Row(
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                SizedBox(
                                                                                    ...
                                                                                    ,onPressed:(){
                                                                                  setState(() {
                                                                                    //    com.deleteMatieres(matieres[id]['id'])
                                                                                    CVM.deleteClasse(classes[id]['id']);
                                                                                    print("aaa");
                                                                                    getEnseignant();
                                                                                    Navigator.pop(context,null);
                                                                                  });
