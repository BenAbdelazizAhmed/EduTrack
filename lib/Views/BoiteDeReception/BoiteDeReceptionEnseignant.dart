...
List img=[
  ...
  void connect() {
    ...
    socket = IO.io('http://192.168.1.13:4000', <String, dynamic>{
                                                ...
                                                GestureDetector(
                                                  ...
                                                  child: Container(
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        CircleAvatar(
                                                          backgroundImage: NetworkImage("http://192.168.1.13/ISIMM_eCampus/storage/app/public/${enseignants[id]['enseignant']['image']}"),
                                                        ),
                                                        SizedBox(width: 10),
                                                        Column(
                                                          crossAxisAlignment: CrossAxisAlignment.start,
                                            ...
                                            if (index < msg.length) {
                                              if (i <= msg.length) {
                                                if (msg[index]['sender_id'] == 6) {
                                                  ...
                                                  i++;
                                                  print(i);
                                                  return OtherMsgWidget(msg: msg[index]['text'],img:msg[index]['enseignant']['image']);
                                                }
                                              }
                                            } else {
