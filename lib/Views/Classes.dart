...
class Classe extends StatefulWidget {
  ...
  @override
  State<Classe> createState() => _ClasseState();
}
...
class _ClasseState extends State<Classe> {
 ...
 bool isSelected=true;
  ...
  Widget build(BuildContext context) {
    ...
    ,onPressed:(){
    setState(() {
    com.AjouterClasse(nom.text,prenom.text );
    getEnseignant();
                           ...
                           children: [
                                                                                    ...
                                                                                    SizedBox(
                                                                                      ...
                                                                                      setState(() {
                                                                                        ...
                                                                                        com.Updateclasse(nom.text, classes[id]['id'].toString());
                                                                                        Navigator.pop(context,null);
                                                                                        getEnseignant();
                                                                                      });
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                SizedBox(
                                                                                  ...
                                                                                  setState(() {
                                                                                    ...
                                                                                    com.deleteClasse(classes[id]['id']);
                                                                                    print("aaa");
                                                                                    getEnseignant();
                                                                                    Navigator.pop(context,null);
                                                                                  });
